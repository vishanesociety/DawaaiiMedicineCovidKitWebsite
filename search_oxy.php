...
$sql = "SELECT * FROM oxy_search WHERE shop_location LIKE '%" . $_POST['name'] . "%'";
        ...
        <div class="contain" id="product-result">
           <form action="manage_cart.php" method="POST">
            ...
            <div style="width: 90% ; border-top: 2px solid grey; margin: 2% 5% 1% 3%;">
                 <h6 style="margin-top: 0.3rem; margin-bottom: 0.5rem;"><b style="font-weight: 900;"><?php echo $row['oxy_equipments'] ?></b></h6>
            </div>
            </form>
        </div>
