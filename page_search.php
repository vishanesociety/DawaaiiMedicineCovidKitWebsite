...
if (isset($_POST['search'])) {
    ...
    $sql = $connection->query("SELECT DISTINCT shop_location FROM medicine_search WHERE shop_location LIKE '%$q%' limit 5");
    if ($sql->num_rows > 0) {
        $response = "<ul>";
        ...
        <div class="header-text" style="margin-top: -5px;">
            <div class="container" id="front-container">
                ...
                <div class="text-area">
                    ...
                    <p class="h6" style="color: #74B9F9; margin-bottom: 3rem; margin-top: 2.5rem;"> <span style="font-weight: bolder;"> Remdesiver, Favipiravir, Fabiflu, Tocilizumab</span></p>
                ...
                <!-- 9 May 2:05 AM -->
                <!-- EDIT THE VALUE OF SUBMIT BUTTONS AND INPUT FIELD -->
               ...
               <div class="address-btn-class">
                ...
                if (isset($_POST['index_search'])) {
                    ...
                    $search_data = $_POST['address-input1'];
                    $_SESSION['search_data'] = $search_data;
                    header('location:result.php');
                } elseif (isset($_POST['address2'])) {
                    $search_data = $_POST['address-input2'];
                    $_SESSION['search_data'] = $search_data;
                    header('location:result.php');
                } elseif (isset($_POST['address3'])) {
                    $search_data = $_POST['address-input3'];
                    $_SESSION['search_data'] = $search_data;
                    header('location:result.php');
                }
                ?>
